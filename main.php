...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
	<div class="container">
		<div class="palay-container homepage-container">
		<div class="row">
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/rice1.png);">
				
			</div>
		</div>
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/rice2.png);">
			</div>
		</div>
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Low Price guarantee</h4>
						</div>
					</div>	
					<h6 class="text">Cash on delivery Only</h6>
				</div>
			</div>
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">Shipping and Pick up basis</h4>
						</div>
					</div>
					<h6 class="text">Shipping fee depends on location</h6>	
				</div>
			</div>
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">Gift for our farmers</h4>
						</div>
					</div>
					<h6 class="text">Let's Help our farmers</h6>	
				</div>
			</div>
		</div>
	</div>
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#bigas" data-toggle="tab">Bigas</a></li>
					<li><a href="#palay" data-toggle="tab">Palay</a></li>
				</ul>
			</div>
...
<?php include('includes/powered-slider.php');?>
</div>
</div>
