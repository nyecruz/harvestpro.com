...
<html lang="en">
	<head>
	    ...
	    <title>Harvest Pro | Product Details</title>
...
?>
			...
			<ul class="list-inline list-unstyled">
				...
				<li><a href="category.php?cid=3"><?php echo htmlentities($rw['catname']);?></a></li>
				<li><a href="sub-category.php?scid=13"><?php echo htmlentities($rw['subcatname']);?></a></li>
				<li class='active'><a href="product-details.php?pid=21"><?php echo htmlentities($rw['pname']);?></a></li>
			</ul>
			<?php }?>
		</div>
	</div>
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                <li><a class="fa fa-facebook" href="https://www.facebook.com/nyex02/"></a></li>
